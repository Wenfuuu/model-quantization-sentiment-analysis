"""
Export QAT-trained FP16 model to ONNX format
Preserves QAT-trained weights for better FP16 accuracy
"""
...
print("="*70)
print("Exporting FP16 QAT Model to ONNX Format")
print("="*70)

save_path_qat = "./models/indobert-qat-fp16-smsa"
...
print("\n" + "="*70)
print("Next step: python quantize_onnx_fp16.py")
print("="*70)
