...
MODEL_PATH = "./models/indobert-smsa-qat-fp16-fake"
...
print(f"FP16 Model loaded from: {MODEL_PATH}")
...
eval_args = TrainingArguments(
    ...
    fp16=True,  # Use FP16 for evaluation as well
    report_to="none"
)
...
print("Running evaluation on test set (FP16)...")
results = trainer.evaluate()

print("\nTest Set Results (FP16)")
print("=" * 70)
...
plt.title("Confusion Matrix - FP16")
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "confusion_matrix_fp16.png"), dpi=300)
plt.close()
...
with open(os.path.join(OUTPUT_DIR, "evaluation_results_fp16.json"), "w") as f:
    json.dump(
        {
...
print("\nDetailed Classification Report (FP16)")
print("=" * 70)
