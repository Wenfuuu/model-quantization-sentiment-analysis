...
def run_xai():
    ...
    if experiment_key == "cross_method":
        compute_cross_method_agreement()
        print_section("CROSS-METHOD AGREEMENT COMPLETED")
        return
