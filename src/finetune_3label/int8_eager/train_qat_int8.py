...
print("="*70)
print("INT8 QAT Training - SMSA Sentiment Analysis")
print("="*70)
...
print(f"✓ INT8 Model loaded: {model.num_parameters():,} parameters")

# Configure QAT for INT8 (per-tensor quantization)
model.train()
...
print(f"  Quantization: INT8 fake quantization (QAT)")
...
print("  2. Quantize to INT8: python quantize_onnx_int8.py")
print("  3. Evaluate INT8: python eval_onnx_int8.py")
print("="*70)
